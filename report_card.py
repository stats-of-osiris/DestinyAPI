...
# "round_stime":        "%.1f" % (np.mean(game_report.sweaty_round_time)),
 ...
 "N_aces":      int(team_report[team_report['allegiance'] == 'us']['medals_ace'].sum()),
 "N_aced":      int(team_report[team_report['allegiance'] == 'them']['medals_ace'].sum()),
 "N_annil":     int(team_report[team_report['allegiance'] == 'us']['medals_annihilation'].sum()),
 "N_annild":    int(team_report[team_report['allegiance'] == 'them']['medals_annihilation'].sum()),
 ...
 "N_morbs":     int(team_report[team_report['allegiance'] == 'us']['orbs_dropped'].sum()),
...
#
# indiv_context = {
#     "Player1":teammate_report.iloc[0]['player'],
#
#     "p1k":	"%.0f" % 	(teammate_report.iloc[0]['kills']),
#     "p1a":	"%.0f" % 	(teammate_report.iloc[0]['assists']),
#     "p1d":	"%.0f" % 	(teammate_report.iloc[0]['deaths']),
#     "p1kd":	"%.2f" % 	(teammate_report.iloc[0]['k_d']),
#     "p1skd":	"%.2f" % 	(teammate_report.iloc[0]['sweaty_k'] / teammate_report.iloc[0]['sweaty_d']),
#     "p1cont":	"%.1f" % 	(teammate_report.iloc[0]['p_cont']),
#     "p1lga":	"%.0f" % 	(teammate_report.iloc[0]['from_the_brink'] + teammate_report.iloc[0]['never_say_die']),
#     "p1wb":	"%.0f" % 	(teammate_report.iloc[0]['wrecking_ball']),
#     "p1mks":	"%.0f" % 	(teammate_report.iloc[0]['max_k_spree']),
#     "p1ll":	"%.0f" % 	(teammate_report.iloc[0]['long_life']),
#     "p1cc":	"%.0f" % 	(teammate_report.iloc[0]['close_call']),
#
#     "Player2":teammate_report.iloc[1]['player'],
#
#     "p2k":	"%.0f" % 	(teammate_report.iloc[1]['kills']),
#     "p2a":	"%.0f" % 	(teammate_report.iloc[1]['assists']),
#     "p2d":	"%.0f" % 	(teammate_report.iloc[1]['deaths']),
#     "p2kd":	"%.2f" % 	(teammate_report.iloc[1]['k_d']),
#     "p2skd":	"%.2f" % 	(teammate_report.iloc[1]['sweaty_k'] / teammate_report.iloc[1]['sweaty_d']),
#     "p2cont":	"%.1f" % 	(teammate_report.iloc[1]['p_cont']),
#     "p2lga":	"%.0f" % 	(teammate_report.iloc[1]['from_the_brink'] + teammate_report.iloc[1]['never_say_die']),
#     "p2wb":	"%.0f" % 	(teammate_report.iloc[1]['wrecking_ball']),
#     "p2mks":	"%.0f" % 	(teammate_report.iloc[1]['max_k_spree']),
#     "p2ll":	"%.0f" % 	(teammate_report.iloc[1]['long_life']),
#     "p2cc":	"%.0f" % 	(teammate_report.iloc[1]['close_call']),
#
#     "Player3":teammate_report.iloc[2]['player'],
#
#     "p3k":	"%.0f" % 	(teammate_report.iloc[2]['kills']),
#     "p3a":	"%.0f" % 	(teammate_report.iloc[2]['assists']),
#     "p3d":	"%.0f" % 	(teammate_report.iloc[2]['deaths']),
#     "p3kd":	"%.2f" % 	(teammate_report.iloc[2]['k_d']),
#     "p3skd":	"%.2f" % 	(teammate_report.iloc[2]['sweaty_k'] / teammate_report.iloc[2]['sweaty_d']),
#     "p3cont":	"%.1f" % 	(teammate_report.iloc[2]['p_cont']),
#     "p3lga":	"%.0f" % 	(teammate_report.iloc[2]['from_the_brink'] + teammate_report.iloc[2]['never_say_die']),
#     "p3wb":	"%.0f" % 	(teammate_report.iloc[2]['wrecking_ball']),
#     "p3mks":	"%.0f" % 	(teammate_report.iloc[2]['max_k_spree']),
#     "p3ll":	"%.0f" % 	(teammate_report.iloc[2]['long_life']),
#     "p3cc":	"%.0f" % 	(teammate_report.iloc[2]['close_call'])
#  }
#
# with  open(file_name,'a') as myfile:
...
#     "Player1":teammate_report.iloc[0]['player'],
#
#     "p1pvs":	"%.1f" % 	(teammate_report.iloc[0]['n_primary'] / (teammate_report.iloc[0]['n_primary'] + teammate_report.iloc[0]['n_special']) * 100),
#     "p1shs":	"%.0f" % 	(teammate_report.iloc[0]['sniper_hshots']),
#     "p1sk":	"%.0f" % 	(teammate_report.iloc[0]['sniper_kills']),
#     "p1sg":	"%.0f" % 	(teammate_report.iloc[0]['shotg_kills']),
#     "p1os":	"%.0f" % 	(teammate_report.iloc[0]['fr_kills'] + teammate_report.iloc[0]['side_kills']),
#     "p1hk":	"%.0f" % 	(teammate_report.iloc[0]['rocket_kills'] + teammate_report.iloc[0]['hmg_kills']),
#     "p1g":	"%.0f" % 	(teammate_report.iloc[0]['melees']),
#     "p1m":	"%.0f" % 	(teammate_report.iloc[0]['grenades']),
#     "p1s":	"%.0f" % 	(teammate_report.iloc[0]['supers']),
#     "p1rez":	"%.0f" % 	(teammate_report.iloc[0]['rezzes']),
#     "p1rezd":	"%.0f" % 	(teammate_report.iloc[0]['rezzed']),
#     "p1fail":	"%.0f" % 	(teammate_report.iloc[0]['deaths'] - teammate_report.iloc[2]['rezzes']),
#     "p1ogen":	"%.0f" % 	(teammate_report.iloc[0]['orbs_gen']),
#     "p1ogath":	"%.0f" % 	(teammate_report.iloc[0]['orbs_gath']),
#
#     "Player2":teammate_report.iloc[1]['player'],
#
#     "p2pvs":	"%.1f" % 	(teammate_report.iloc[1]['n_primary'] / (teammate_report.iloc[1]['n_primary'] + teammate_report.iloc[1]['n_special']) * 100),
#     "p2shs":	"%.0f" % 	(teammate_report.iloc[1]['sniper_hshots']),
#     "p2sk": 	"%.0f" % 	(teammate_report.iloc[1]['sniper_kills']),
#     "p2sg": 	"%.0f" % 	(teammate_report.iloc[1]['shotg_kills']),
#     "p2os": 	"%.0f" % 	(teammate_report.iloc[1]['fr_kills'] + teammate_report.iloc[1]['side_kills']),
#     "p2hk": 	"%.0f" % 	(teammate_report.iloc[1]['rocket_kills'] + teammate_report.iloc[1]['hmg_kills']),
#     "p2g":	      "%.0f" % 	(teammate_report.iloc[1]['melees']),
#     "p2m":	"%.0f" % 	(teammate_report.iloc[1]['grenades']),
#     "p2s":	"%.0f" % 	(teammate_report.iloc[1]['supers']),
#     "p2rez":	"%.0f" % 	(teammate_report.iloc[1]['rezzes']),
#     "p2rezd":	"%.0f" % 	(teammate_report.iloc[1]['rezzed']),
#     "p2fail":	"%.0f" % 	(teammate_report.iloc[1]['deaths'] - teammate_report.iloc[2]['rezzes']),
#     "p2ogen":	"%.0f" % 	(teammate_report.iloc[1]['orbs_gen']),
#     "p2ogath":	"%.0f" % 	(teammate_report.iloc[1]['orbs_gath']),
#
#     "Player3":teammate_report.iloc[2]['player'],
#
#     "p3pvs":	"%.1f" % 	(teammate_report.iloc[2]['n_primary'] / (teammate_report.iloc[2]['n_primary'] + teammate_report.iloc[2]['n_special']) * 100),
#     "p3shs":	"%.0f" % 	(teammate_report.iloc[2]['sniper_hshots']),
#     "p3sk":	"%.0f" % 	(teammate_report.iloc[2]['sniper_kills']),
#     "p3sg":	"%.0f" % 	(teammate_report.iloc[2]['shotg_kills']),
#     "p3os":	"%.0f" % 	(teammate_report.iloc[2]['fr_kills'] + teammate_report.iloc[2]['side_kills']),
#     "p3hk":	"%.0f" % 	(teammate_report.iloc[2]['rocket_kills'] + teammate_report.iloc[2]['hmg_kills']),
#     "p3g":	"%.0f" % 	(teammate_report.iloc[2]['melees']),
#     "p3m":	"%.0f" % 	(teammate_report.iloc[2]['grenades']),
#     "p3s":	"%.0f" % 	(teammate_report.iloc[2]['supers']),
#     "p3rez":	"%.0f" % 	(teammate_report.iloc[2]['rezzes']),
#     "p3rezd":	"%.0f" % 	(teammate_report.iloc[2]['rezzed']),
#     "p3fail":	"%.0f" % 	(teammate_report.iloc[2]['deaths'] - teammate_report.iloc[2]['rezzes']),
#     "p3ogen":	"%.0f" % 	(teammate_report.iloc[2]['orbs_gen']),
#     "p3ogath":	"%.0f" % 	(teammate_report.iloc[2]['orbs_gath'])
#
#  }
#
# with  open(file_name,'a') as myfile:
